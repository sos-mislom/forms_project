...
const AddContainer = ({fields, questions, onAddQuestion, onDeleteQuestion, onUpdateQuestion, onUpdateField, onDeleteField}) => {
        ...
        switch (item.type) {
            case 'picture':
                return  <div className="uploaded">
                            ...
                            <button className='delete-uploaded' onClick={() => onDeleteField(item.id)}>
            ...
            case 'text':
                return  <FieldText key={item.id } id={item.id} onUpdateField={onUpdateField}/>;
            case 'title':
                return  <FieldTitle key={item.id } id={item.id} onUpdateField={onUpdateField}/>;
            case 'single':
                return <QuestionSingle key={item.id } id={item.id} onDelete={onDeleteQuestion} onUpdateQuestion={onUpdateQuestion}/>;
            case 'multiple':
                return <QuestionMultiple key={item.id} id={item.id} onDelete={onDeleteQuestion} onUpdateQuestion={onUpdateQuestion}/>;
            case 'dropdown':
                return <QuestionDropdown key={item.id} id={item.id} onDelete={onDeleteQuestion} onUpdateQuestion={onUpdateQuestion}/>;
            case 'short':
                return <QuestionShort key={item.id} id={item.id} onDelete={onDeleteQuestion} onUpdateQuestion={onUpdateQuestion}/>;
            case 'long':
                return <QuestionLong key={item.id} id={item.id} onDelete={onDeleteQuestion} onUpdateQuestion={onUpdateQuestion}/>;
            case 'scale':
                return <QuestionScale key={item.id} id={item.id} onDelete={onDeleteQuestion} onUpdateQuestion={onUpdateQuestion}/>;
            default:
                return null;
        }
    };
    const combinedItems = [...fields, ...questions].sort((a, b) => a.createdAt - b.createdAt);
    return (
        <div className="add-container">
            <div className="question-container">
                {combinedItems.map(render)}
            </div>
            <DropdownQuestions onAddQuestion={onAddQuestion} />
        </div>
    );
};
