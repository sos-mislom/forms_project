...
const QuestionSingle = ({ id, onDelete, onUpdate, questionText, initialOptions, initialCorrectAnswers, currentScore, userAnswer, isUserAnswer }) => {
    ...
    useEffect(() => {
        onUpdate(id, { type: 'single', textQuestion, options, score, correctAnswers });
            ...
            <div>
                ...
                <div style={{ display: 'flex', alignItems: 'center' }}>
                    <input
                        ...
                        style={{ width: '45px', marginRight: '5px', marginLeft: '533px', color:'rgba(0, 31, 40, 0.9)'}}
                        placeholder="0"
                        disabled={isUserAnswer}
                    />
