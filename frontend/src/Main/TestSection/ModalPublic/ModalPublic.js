...
const ModalPublic = ({ isOpen, onClose}) => {
    const copyToClipboard = () => {
        navigator.clipboard.writeText('https://docs.google.com/document/d/12flHLHvd-Jmhhm.ru')
            .then(() => {
        ...
        <div className="modal-overlay-public">
            <div className="modal-public">
                ...
                <div className="link-container">
                    <span className="link">https://docs.google.com/document/d/12flHLHvd-Jmhhm.ru</span>
